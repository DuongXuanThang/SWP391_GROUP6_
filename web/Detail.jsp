                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6">
                        <div class="product__item">
                            ...
                            <div class="product__item__text">
                                <h6><a href="#">${listP.get(1).getName()}</a></h6>
                                <h5>${listP.get(1).getPrice()} VND</h5>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-4 col-sm-6">
                        <div class="product__item">
                            ...
                            <div class="product__item__text">
                                <h6><a href="#">${listP.get(2).getName()}</a></h6>
                                <h5>${listP.get(2).getPrice()} VND</h5>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-4 col-sm-6">
                        <div class="product__item">
                            ...
                            <div class="product__item__text">
                                <h6><a href="#">${listP.get(3).getName()}</a></h6>
                                <h5>${listP.get(3).getPrice()} VND</h5>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-4 col-sm-6">
                        <div class="product__item">
                            ...
                            <div class="product__item__text">
                                ...
                                <h5>${listP.get(4).getPrice()} VND</h5>
                            </div>
                        </div>
                    </div>
                </div>
