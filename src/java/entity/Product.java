...
public class Product {
    ...
    public Product(int id, String name, String image, String price, String title, String description, String image1, String image2, String image3, String information) {
        this.id = id;
        this.name = name;
        this.image = image;
        this.price = price;
